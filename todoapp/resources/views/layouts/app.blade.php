...
<head>
    ...
    <!-- CSS読み込む記述をして下さい。 -->
    <link href="{{ secure_asset('scss/header.scss') }}" rel="stylesheet">
    <link href="{{ secure_asset('scss/list_new.scss') }}" rel="stylesheet">
    <link href="{{ secure_asset('scss/top.scss') }}" rel="stylesheet">
